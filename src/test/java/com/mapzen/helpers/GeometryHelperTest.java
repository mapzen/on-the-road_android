...
public class GeometryHelperTest {
    ...
    public void testGetBearing() throws Exception {
        ...
        collection.put(328,
                new double[][] { { 40.660202, -73.987441 }, { 40.660397, -73.987601 } });
        collection.put(309,
                new double[][] { { 40.660735, -73.987878 }, { 40.661404, -73.988983 } });
        collection.put(201,
                new double[][] { { 40.661404, -73.988983 }, { 40.660713, -73.989341 } });

        Iterator it = collection.entrySet().iterator();
        while (it.hasNext()) {
            Map.Entry<Integer, double[][]> entry =
                    (Map.Entry<Integer, double[][]>) it.next();
            assertThat(Math.round(GeometryHelper.getBearing(entry.getValue()[0],
