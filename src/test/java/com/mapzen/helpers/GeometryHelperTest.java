...
public class GeometryHelperTest {
    ...
    public void testGetBearing() throws Exception {
        ...
        l1.add(new MapzenLocation(40.660713, -73.989341));
        l1.add(new MapzenLocation(40.659816, -73.98784));
        collection.put(128, l1);

        List<Location> l2 = new ArrayList<Location>();
        l2.add(new MapzenLocation(40.659816, -73.98784));
        l2.add(new MapzenLocation(40.660202, -73.987441));
        collection.put(38, l2);

        List<Location> l3 = new ArrayList<Location>();
        l3.add(new MapzenLocation(40.660202, -73.987441));
        l3.add(new MapzenLocation(40.660397, -73.987601));
        collection.put(328, l3);

        List<Location> l4 = new ArrayList<Location>();
        l4.add(new MapzenLocation(40.660735, -73.987878));
        l4.add(new MapzenLocation(40.661404, -73.988983));
        collection.put(309, l4);

        List<Location> l5 = new ArrayList<Location>();
        l5.add(new MapzenLocation(40.661404, -73.988983));
        l5.add(new MapzenLocation(40.660713, -73.989341));
